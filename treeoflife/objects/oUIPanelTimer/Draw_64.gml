...
scr_draw_set(1, c_white, function() {
	...
	/// Timer background
	draw_sprite_stretched_ext(sGUI, 3, window_get_width() - 118, 40, y+160, 40, image_blend, image_alpha);
	
	/// Bar
	if (time > 0) draw_sprite_stretched_ext(sPlayer, 0, window_get_width() - 118 - 100, y-17, 200 * ((time) / startTime) , 35, 195513, image_alpha);
	else draw_sprite_stretched_ext(sPlayer, 0, window_get_width() - 118 - 100, 23, 200, 35, c_red, (y/ystart));

	/// Timer border and text
	draw_sprite_stretched_ext(sGUI, 2, window_get_width() - 118, 40, y+160, 40, image_blend, image_alpha);
